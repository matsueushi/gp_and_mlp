...
function predict(gps::GPStandard, gpk::GPKernel,  xtrain::Array, ytrain::Array{T}, xtest::Array) where {T <: Real}
...
function predict(gp::GaussianProcess, xtrain::Array, ytrain::Array{T}, xtest::Array) where {T <: Real}
    predict(gp.method, gp.gpk, xtrain, ytrain, xtest)
end
